...
?>
    ...
    <table  class="table"  align='center' width="10%">
        <tr>
            ...
            <th align='center' width="10%">Product Category</th>
            <th align='center' width="10%">Suggested retail price</th>
            <th align='center' width="10%">Product State</th>
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo "<form method='post' action='m_product_handler.php'><tr>";
    ...
    echo "<input type='hidden' name='p_description' value='$p_description'>";
    ...
    echo "<td align='center'>".$p_description."</td>";
...
echo "<td></td>";
?>
<form method='post' action='m_product_handler.php'>
<td align='center'>
