    ...
    <script type="text/javascript">
        ...
        function registerClientMethods(chatHub) {
            ...
            chatHub.client.onUserDisconnected = function (id, userName) {
                ...
                $(disc).fadeIn(10).delay(10).fadeOut(10);
        ...
        function AddMessage(userName, message, time, userimg) {
         ...
         <style>
            logo-lg img {
                width: 50 px; /* Adjust the width as needed */
            height: auto;
...
<body>
    ...
    <span class="logo-lg"><img src="images/icon1.png" alt="SignalR Chat App Logo" style="width: 130px; height: 50px;"></span>
        </a>
